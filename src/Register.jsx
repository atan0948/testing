...
const inputStyle = {
    ...
    padding: '14px',
    borderRadius: '5px',
    width: '100%', // Changed to 100% for full-width input
...
const linkButtonStyle = {
    ...
    width: '100%',
    display: 'inline-block', // To allow width and other styles to apply
};
        ...
        <div style={containerStyle}>
            <div style={formContainerStyle}>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        <label htmlFor="name" style={{ fontSize: '1rem', marginBottom: '8px' }}><strong>Name</strong></label>
                        <input
                            type="text"
                            id="name"
